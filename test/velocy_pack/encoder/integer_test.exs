defmodule VelocyPack.Encoder.IntegerTest do
  ...
  test "encode/2 small positive integers" do
  ...
  test "encode/2 small negative integers" do
  ...
  test "encode/2 signed integers" do
  ...
  test "encode/2 unsigned integers" do
  ...
  test "encode_with_size/2 small positive integers" do
  ...
  test "encode_with_size() unsigned integers" do
    ...
    assert Encoder.encode_with_size(18_446_744_073_709_551_615) ===
